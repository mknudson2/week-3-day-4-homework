...
"""
steps:
1. count the occurances of a color in the input
2. filter out those which don't form a pair
"""
...
print(make_pairs(["red", "green", "red", "blue", "blue", "blue"]))
print(make_pairs(["red", "red", "red", "red", "red", "red", "red"]))
